...
**Project analysed:** `senadeep5-clemson-university/xenon-graph-pooling-pmain-fraction-enriched`  
**Generated:** 2026-07-23T12:44:42.057107-04:00
...
Primary objective: **`val_p_main_mse`** (minimize). It is explicitly the sweep objective in `Models/deepset_sweep.py` when present; otherwise the report falls back to the first available common validation metric. `loss` is used for loss-curve diagnostics.
...
|:------------------------------------|:---------|:---------|---------------:|----------------:|----------------:|-----------------:|-----------------------:|--------------------:|--------------:|
| sum-mean-max-fracweight2-seed42     | 2yu9mdk1 | finished |        0.06142 |         0.06225 |             nan |              114 |                0.00030 |                1024 |            42 |
| sum-mean-max-fracweight4-seed42     | nprze393 | finished |        0.06314 |         0.06438 |             nan |               94 |                0.00030 |                1024 |            42 |
| bce-sum-mean-max-fracweight4-seed42 | z70gvclj | finished |        0.06351 |         0.06700 |             nan |               81 |                0.00030 |                1024 |            42 |

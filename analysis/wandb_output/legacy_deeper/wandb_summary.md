...
**Project analysed:** `senadeep5-clemson-university/xenon-graph-pooling-deeper-tie-aware`  
**Generated:** 2026-07-23T12:46:56.933765-04:00
...
Primary objective: **`val_mean_auc`** (maximize). It is explicitly the sweep objective in `Models/deepset_sweep.py` when present; otherwise the report falls back to the first available common validation metric. `val_loss` is used for loss-curve diagnostics.
...
|:-----------------|:---------|:---------|---------------:|----------------:|----------------:|-----------------:|-----------------------:|--------------------:|--------------------:|--------------------:|
| sage-breeze-1    | 9ucyed06 | finished |        0.93778 |         0.93777 |         0.26543 |              186 |                0.00100 |                 512 |                  64 |                 128 |
| spring-terrain-2 | 6jjdmn58 | finished |        0.93541 |         0.93540 |         0.08112 |              165 |                0.00100 |                 512 |                  64 |                 128 |
...
|:-----------------|:---------|----------------:|-----------------:|------------------:|
| sage-breeze-1    | 9ucyed06 |         0.26543 |          0.26544 |           0.00001 |
| spring-terrain-2 | 6jjdmn58 |         0.08112 |          0.08112 |           0.00000 |
